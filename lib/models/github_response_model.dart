...
//
//     final githubResponseModel = githubResponseModelFromJson(jsonString);

import 'dart:convert';

import 'package:flutter_pagination_infinite_scrolling/models/github_model.dart';

GithubResponseModel githubResponseModelFromJson(String str) =>
    GithubResponseModel.fromJson(json.decode(str));

String githubResponseModelToJson(GithubResponseModel data) =>
